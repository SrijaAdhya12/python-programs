    updated on: 05th February 2025, Wednesday

<div align=center>
    <a href="https://github.com/SrijaAdhya12/python-programs">
        <img width="200" src="https://img.icons8.com/?size=1000&id=46874" alt="python-programs">
    </a>
    <p style="font-family: roboto, calibri; font-size:12pt; font-style:italic"> A good one liner description here </p>
    <a src="https://github.com/SrijaAdhya12/python-programs/forks">
        <img alt="GitHub forks" src="https://img.shields.io/github/forks/SrijaAdhya12/python-programs">
    </a>
</div>

# [Python Programs](https://github.com/SrijaAdhya12/python-programs)
...
2. Go to [**Security**](https://github.com/SrijaAdhya12/python-programs/security) tab.
3. Click on **Security Overview**.
4. Click on `Enable Dependabot alerts` button.

- Enable Code Scanning Alerts

1. Go to [Code security and analysis](https://github.com/SrijaAdhya12/python-programs/settings/security_analysis#code_scanning_settings) section in settings.
...
<div align="center">
    <a href="https://github.com/SrijaAdhya12/python-programs/graphs/contributors">
        <img src="https://contrib.rocks/image?repo=SrijaAdhya12/python-programs" alt="contributors"/>
    </a>
</div>
